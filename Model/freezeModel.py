...
# TODO load model folder in
# TODO Remove redundant metadata
# TODO Serialize model into a Frozen format
...
def freeze_graph(model_dir, output_node_names):
    ...
    with tf.compat.v1.Session(graph=tf.Graph()) as sess:
        ...
        with tf.compat.v2.io.gfile.GFile(output_graph, "wb") as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_dir", type=str, default="./trainedModels/m4/", help="Model folder to export")
